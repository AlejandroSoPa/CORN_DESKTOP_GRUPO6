...
public class colorsController {
    ...
    private void loadColorsCallback (String response) {
        ...
        if (objResponse.getString("status").equals("OK")) {
            ...
            URL resource = this.getClass().getResource("./assets/listcolorbutton.fxml");
            ...
            for (int i = 0; i < JSONlist.length(); i++) {
                ...
                try {
                    ...
                    ControllerColorButton itemControlle = loader.getController();
    ...
    public void loadColors(){
        ...
        UtilsHTTP.sendPOST(Main.protocol + "://" + Main.host + ":" + Main.port + "/dades", obj.toString(), (response) -> {
            this.loadColorsCallback(response);
