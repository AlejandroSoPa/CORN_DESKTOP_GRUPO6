...
public class ControllerMarques {
    ...
    private void loadMarquesCallback (String response) {
        ...
        if (objResponse.getString("status").equals("OK")) {
            ...
            URL resource = this.getClass().getResource("./assets/listmarquesbutton.fxml");
            ...
            for (int i = 0; i < JSONlist.length(); i++) {
                ...
                try {
                    ...
                    ControllerMarquesButton itemControlle = loader.getController();
    ...
    public void loadMarques(){
        ...
        UtilsHTTP.sendPOST(Main.protocol + "://" + Main.host + ":" + Main.port + "/dades", obj.toString(), (response) -> {
            ...
            this.loadMarquesCallback(response);
